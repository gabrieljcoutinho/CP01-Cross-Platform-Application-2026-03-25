...
const genres = [
  { id: '1', name: 'Rock', key: 'rock', img: require('../imgs/Rock.png') },
  { id: '2', name: 'Eletrônico', key: 'eletronico', img: require('../imgs/Eletronico.png') },
  { id: '3', name: 'Sertanejo', key: 'sertanejo', img: require('../imgs/Sertanejo.png') },
  { id: '4', name: 'Funk', key: 'funk', img: require('../imgs/Funk.png') },
  { id: '5', name: 'Rap', key: 'rap', img: require('../imgs/Rap.png') },
  { id: '6', name: 'Pagode', key: 'pagode', img: require('../imgs/Samba.png') },
];
      ...
      <S.ScrollArea>
        <Animated.View style={{ opacity: fadeAnim }}>
          <S.ContentWrapper>
            ...
            <S.GenreGrid>
              {genres.map((item) => (
                <S.GenreCard key={item.id} onPress={() => onSelectVibe(item.key)}>
...
/* O Grid deve usar flex-wrap para ajustar colunas conforme o tamanho do dispositivo */